...
void TrafficLight::_bind_methods() {
	...
	ClassDB::bind_method(D_METHOD("set_light_type", "texture"), &TrafficLight::set_light_type);
	...
	ADD_PROPERTY(PropertyInfo(Variant::INT, "light_type", godot::PROPERTY_HINT_ENUM, "Go,Stop,Caution"), "set_light_type", "get_light_type");
